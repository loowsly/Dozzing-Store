...
client.on("ready", () => {
    let activities = [
        `Remaster`, `By: zTralha`, `Versao 0 bugs`
      ],
      i = 0;
  ...
  return;
            ...
            interaction.guild.channels.create(`🛒・carrinho- ${interaction.user.username}`, {
               ...
               .addComponents(
                ...
                .setThumbnail(`${dbB.get(`foto`)}`)
                .setImage(`${dbB.get(`banner`)}`)
                .setDescription(` ***Antes de continuar com sua compra, lembre-se de ler nossos termos!*** \n\n\ **Termos: <#${dbB.get(`canaltermos`)}>** \n\n\ **Use ✅ - Para Aceitar e continuar com sua compra** \n **Use ❌ - Para Cancelar a compra** `)
                .setColor(`${dbB.get(`cor`)}`)
                                ...
                                .addComponents(
                                    ...
                                    .addComponents(
                                        new Discord.MessageButton()
                                            ...
                                            .setLabel("Cupom")
                                            .setEmoji('<:anotacao:1064399273665503262>')
                                            .setStyle("PRIMARY"),
                                    )    
...
msg.channel.bulkDelete(50);
                                        ...
                                        mercadopago.payment.create(payment_data).then(function (data) {
                                            ...
                                            const row = new Discord.MessageActionRow()
                                                ...
                                                .addComponents(
                                                    new Discord.MessageButton()
                                                        .setCustomId('paypal')
                                                        .setEmoji('<:paypal:1053282399586353272>')
                                                        .setLabel("Paypal")
                                                        .setDisabled(true)
                                                        .setStyle("SUCCESS"),
                                                )
                                                        ...
                                                        .addComponents(
                                                            new Discord.MessageButton()
                                                                .setCustomId('Bitcoin')
                                                                .setEmoji('<:Bitcoin:1048830645331304468>')
                                                                .setLabel("Bitcoin")
                                                                .setDisabled(true)
                                                                .setStyle("SUCCESS"),
                                                )
                                                ...
                                                const lopp = setInterval(function () {
                                                    ...
                                                    axios.get(`https://api.mercadolibre.com/collections/notifications/${data.body.id}`, {
                                                        ...
                                                        if (doc.data.collection.status === "approved") {
                                                            ...
                                                            msg.channel.send(`🌟 | ID da sua compra || ${data.body.id} || `)
                                  ...
                                  .setThumbnail(msg.guild.iconURL({dynamyc: true}))
                                                                ...
                                                                .addField(` | **ID DA COMPRA**:`, `\`${data.body.id}\``)
                                                               .setColor(`${dbB.get(`cor`)}`)
                                                               .setFooter(`${dbB.get(`nomebot`)} | Todos os Direitos Reservados`)
                                                               .setThumbnail(`${dbB.get(`foto`)}`)
